    ...
    return (
      ...
      relative hover:cursor-pointer shadow-[5px_5px_10px_0px_rgba(0,0,0,0.3)]'>
            <div className='h-auto w-[90%] flex flex-col items-center absolute z-10 mt-10'>
                ...
                <button className='h-auto w-[30%] absolute bg-sky-700 bottom-0 text-white text-2xl font-bold p-3 '>Read more</button>
            </div>
              <div className='h-full w-full flex justify-center'>
                  ...
                  <div className='bg-sky-700/50 absolute h-full w-full rounded-md'></div>
                  <div className='w-full h-[40%] bottom-0 absolute bg-gradient-to-b from-transparent rounded-b-md to-black'></div>
              </div>
          </div>
      </div>
    )
