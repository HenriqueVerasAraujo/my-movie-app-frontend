...
export default function ReviewCard({ review }) {
  ...
  return (
    <div className='w-[70%] h-[120px] flex flex-col bg-neutral-200  rounded-md shadow-[5px_5px_10px_0px_rgba(0,0,0,0.3)] hover:shadow-[10px_10px_20px_0px_rgba(0,0,0,0.3)] hover:cursor-pointer hover:-translate-x-2 hover:-translate-y-2 duration-200 ease-in-out'>
       {/* HEADER */}
